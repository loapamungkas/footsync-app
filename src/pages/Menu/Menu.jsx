...
import { assets, products_list } from '../../assets/menu';
import CardProduct from '../../components/CardProduct';

const Menu = () => {
  return (
    <div className="max-w-screen-2xl container py-28 mx-auto xl:px-24">
      <section>
        <div className="mx-auto max-w-screen-2xl container ">
          <header>
            <h2 className="text-xl font-bold text-gray-900 sm:text-3xl">Product Collection</h2>

            <p className="mt-4 max-w-md text-gray-500">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Itaque praesentium cumque iure dicta incidunt est ipsam, officia dolor fugit natus?</p>
          </header>
